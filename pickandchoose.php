...
function myErrorDetector($errno, $errstr, $errfile, $errline, $errcontext) {
    //echo "<b>Error:</b> [$errno] $errstr";
    $error = array('Error' => $errstr, 'Line' => $errline, 'File' => $errfile);
    echo json_encode($error);
    die();
  }
  
  //set error handler
  set_error_handler("myErrorDetector");
...
which has all ready been created and tested. Test
*/
